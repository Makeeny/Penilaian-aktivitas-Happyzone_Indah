...
<?php $__env->startSection('title', 'Edit Penilaian Siswa'); ?>
...
<div class="form-container-custom">
    <div class="header-custom">
        ...
        <p>Ubah data pada form di bawah ini untuk siswa <strong><?php echo e($assessment->profilSiswa->nama_lengkap); ?></strong>.</p>
    </div>
    ...
    <div class="form-card-custom">
        <div class="card-title-bar">
            ...
            <a href="<?php echo e(url()->previous()); ?>" class="back-button-custom">Kembali</a>
        </div>

        <form action="<?php echo e(route('guru.penilaian.update', $assessment->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-grid-custom">
                ...
                <div class="form-group-custom">
                    ...
                    <input type="text" class="form-control-custom" value="<?php echo e($assessment->profilSiswa->nama_lengkap); ?>" readonly>
                </div>
                <div class="form-group-custom">
                    <label>Mata Pelajaran</label>
                    <input type="text" class="form-control-custom" value="<?php echo e($assessment->subject->nama_mapel); ?>" readonly>
                </div>
                <div class="form-group-custom">
                    <label for="materi_pembelajaran">Materi Pembelajaran / Aktivitas</label>
                    <input type="text" name="materi_pembelajaran" id="materi_pembelajaran" class="form-control-custom" value="<?php echo e(old('materi_pembelajaran', $assessment->aktivitas)); ?>" required>
                </div>
                <div class="form-group-custom">
                    <label>Tanggal Penilaian</label>
                    <input type="text" class="form-control-custom" value="<?php echo e(\Carbon\Carbon::parse($assessment->tanggal)->format('d F Y')); ?>" readonly>
                </div>
                ...
                <div class="form-group-custom">
                    <label for="indikator_c1">Partisipasi Akademik (C1) - Indikator</label>
                     <select name="indikator[C1]" id="indikator_c1" class="form-control-custom" required>
                        <option value="Sangat Aktif" <?php echo e(old('indikator.C1', $assessment->indikator_c1) == 'Sangat Aktif' ? 'selected' : ''); ?>>Sangat Aktif</option>
                        <option value="Aktif" <?php echo e(old('indikator.C1', $assessment->indikator_c1) == 'Aktif' ? 'selected' : ''); ?>>Aktif</option>
                        <option value="Cukup Aktif" <?php echo e(old('indikator.C1', $assessment->indikator_c1) == 'Cukup Aktif' ? 'selected' : ''); ?>>Cukup Aktif</option>
                        <option value="Kurang Aktif" <?php echo e(old('indikator.C1', $assessment->indikator_c1) == 'Kurang Aktif' ? 'selected' : ''); ?>>Kurang Aktif</option>
                        <option value="Tidak Aktif" <?php echo e(old('indikator.C1', $assessment->indikator_c1) == 'Tidak Aktif' ? 'selected' : ''); ?>>Tidak Aktif</option>
                    </select>
                </div>
                <div class="form-group-custom">
                    <label for="nilai_c1">Partisipasi Akademik (C1) - Nilai</label>
                    <input type="number" name="nilai_mentah[1]" id="nilai_c1" class="form-control-custom nilai-kriteria" value="<?php echo e(old('nilai_mentah.1', $assessment->nilai_c1)); ?>" data-bobot="<?php echo e($kriterias->firstWhere('kode_kriteria', 'C1')->bobot); ?>" required>
               </div>
                ...
                <div class="form-group-custom">
                    ...
                    <select name="indikator[C2]" id="indikator_c2" class="form-control-custom" required>
                        <option value="Sangat Disiplin" <?php echo e(old('indikator.C2', $assessment->indikator_c2) == 'Sangat Disiplin' ? 'selected' : ''); ?>>Sangat Disiplin</option>
                        <option value="Disiplin" <?php echo e(old('indikator.C2', $assessment->indikator_c2) == 'Disiplin' ? 'selected' : ''); ?>>Disiplin</option>
                        <option value="Cukup Disiplin" <?php echo e(old('indikator.C2', $assessment->indikator_c2) == 'Cukup Disiplin' ? 'selected' : ''); ?>>Cukup Disiplin</option>
                        <option value="Kurang Disiplin" <?php echo e(old('indikator.C2', $assessment->indikator_c2) == 'Kurang Disiplin' ? 'selected' : ''); ?>>Kurang Disiplin</option>
                    </select>
                </div>
                <div class="form-group-custom">
                    <label for="nilai_c2">Kedisiplinan (C2) - Nilai</label>
                    <input type="number" name="nilai_mentah[2]" id="nilai_c2" class="form-control-custom nilai-kriteria" value="<?php echo e(old('nilai_mentah.2', $assessment->nilai_c2)); ?>" data-bobot="<?php echo e($kriterias->firstWhere('kode_kriteria', 'C2')->bobot); ?>" required>
                </div>
                ...
                <div class="form-group-custom">
                    ...
                    <select name="indikator[C3]" id="indikator_c3" class="form-control-custom" required>
                        <option value="Sangat baik" <?php echo e(old('indikator.C3', $assessment->indikator_c3) == 'Sangat baik' ? 'selected' : ''); ?>>Sangat baik</option>
                        <option value="Baik" <?php echo e(old('indikator.C3', $assessment->indikator_c3) == 'Baik' ? 'selected' : ''); ?>>Baik</option>
                        <option value="Cukup baik" <?php echo e(old('indikator.C3', $assessment->indikator_c3) == 'Cukup baik' ? 'selected' : ''); ?>>Cukup baik</option>
                        <option value="Kurang baik" <?php echo e(old('indikator.C3', $assessment->indikator_c3) == 'Kurang baik' ? 'selected' : ''); ?>>Kurang baik</option>
                    </select>
                </div>
                <div class="form-group-custom">
                    <label for="nilai_c3">Etika dan Perilaku (C3) - Nilai</label>
                    <input type="number" name="nilai_mentah[3]" id="nilai_c3" class="form-control-custom nilai-kriteria" value="<?php echo e(old('nilai_mentah.3', $assessment->nilai_c3)); ?>" data-bobot="<?php echo e($kriterias->firstWhere('kode_kriteria', 'C3')->bobot); ?>" required>
                </div>
                ...
                <div class="form-group-custom">
                    ...
                    <select name="indikator[C4]" id="indikator_c4" class="form-control-custom" required>
                        <option value="≤ 5 Tugas" <?php echo e(old('indikator.C4', $assessment->indikator_c4) == '≤ 5 Tugas' ? 'selected' : ''); ?>>≤ 5 Tugas</option>
                        <option value="≥ 5 – 10 Tugas" <?php echo e(old('indikator.C4', $assessment->indikator_c4) == '≥ 5 – 10 Tugas' ? 'selected' : ''); ?>>≥ 5 – 10 Tugas</option>
                        <option value="≥ 10 – 15 Tugas" <?php echo e(old('indikator.C4', $assessment->indikator_c4) == '≥ 10 – 15 Tugas' ? 'selected' : ''); ?>>≥ 10 – 15 Tugas</option>
                    </select>
                </div>
                <div class="form-group-custom">
                   <label for="nilai_c4">Tugas Tdk Dikerjakan (C4) - Nilai</label>
                   <input type="number" name="nilai_mentah[4]" id="nilai_c4" class="form-control-custom nilai-kriteria" value="<?php echo e(old('nilai_mentah.4', $assessment->nilai_c4)); ?>" data-bobot="<?php echo e($kriterias->firstWhere('kode_kriteria', 'C4')->bobot); ?>" required>
                </div>

                
                <div class="form-group-custom grid-full-width">
                    <label for="poin_hasil_display">Total Poin Hasil (Otomatis)</label>
                    <input type="text" id="poin_hasil_display" name="total_poin" class="form-control-custom" value="<?php echo e(old('total_poin', $assessment->total_poin)); ?>" readonly style="font-weight: bold; background-color: #e9ecef;">
                </div>

                <div class="form-group-custom grid-full-width">
                    <label for="feedback">Feedback:</label>
                    <textarea name="feedback" id="feedback" class="form-control-custom"><?php echo e(old('feedback', $assessment->feedback)); ?></textarea>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.guru', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\happy-zone-final\resources\views/guru/penilaian/edit.blade.php ENDPATH**/ ?>