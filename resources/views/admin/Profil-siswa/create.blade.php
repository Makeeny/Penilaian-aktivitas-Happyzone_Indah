...
<div class="page-header">
    <h1>{{ $title }}</h1>
    <div>
        <a href="{{ route('admin.profil-siswa.index') }}" class="btn btn-secondary">Batal</a>
    </div>
</div>
...
<div class="form-card">
    ...
    <form action="{{ route('admin.profil-siswa.store') }}" method="POST">
        @csrf
        ...
        <div class="form-grid">
            <div class="form-group">
                <label for="email">Email Akun (Orang Tua)</label>
        ...
        <div class="form-group full-width">
            ...
            <input type="text" name="no_telepon_ortu" id="no_telepon_ortu" class="form-control" value="{{ old('no_telepon_ortu') }}">
        </div>

        <button type="submit" class="btn-submit" style="margin-top: 10px;">Simpan Data Siswa</button>
    </form>
</div>
@endsection
