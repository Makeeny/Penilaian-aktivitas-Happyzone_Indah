...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard siswa'); ?> - Happy Zone</title>
...
<body>
    <div class="wrapper">
        ...
        <ul class="nav-list">
            ...
            <li class="nav-item <?php echo e(request()->is('siswa/penilaian*') ? 'active' : ''); ?>">
            
            <li class="nav-item <?php echo e(request()->is('feedback*') ? 'active' : ''); ?>">
                
                <a href="<?php echo e(route('feedback.create')); ?>" class="nav-link">
            ...
            <li class="nav-item <?php echo e(request()->is('siswa/rekap-poin*') ? 'active' : ''); ?>">
                
                <?php if($firstSubject): ?>
                    <a href="<?php echo e(route('siswa.rekap-poin.show', $firstSubject->id)); ?>" class="nav-link">
        ...
        <div class="main-content full-width" id="main-content">
            <header class="header">
                <div class="header-left">
                    ...
                    <a href="<?php echo e(route('siswa.dashboard')); ?>" class="header-logo" id="header-logo" style="text-decoration: none;">
                        <img src="<?php echo e(asset('images/logohappyzone.png')); ?>" alt="Logo">
                        <span class="header-title">Happy Zone</span>
                    </a>
                </div>
                <nav class="header-nav">
                    <a href="<?php echo e(route('siswa.notifications.index')); ?>"><i class="fas fa-bell"></i></a>
...
</html><?php /**PATH C:\laragon\www\happy-zone-final\resources\views/layouts/siswa.blade.php ENDPATH**/ ?>