...
<head>
    ...
    <title>@yield('title', 'Dashboard Guru') - Happy Zone</title>
...
<body>
    <div class="wrapper">
        {{-- REVISI: Sidebar diberi class .collapsed agar tersembunyi saat awal --}}
    ...
    <ul class="nav-list">
    {{-- REVISI: Logika 'active' diubah menggunakan request()->is() --}}
    {{-- Class 'active' akan ditambahkan jika URL saat ini mengandung 'guru/penilaian' --}}
    <li class="nav-item {{ request()->is('guru/penilaian*') ? 'active' : '' }}">
        ...
        <ul class="sub-menu">
            @if(isset($listMapelForSidebar))
                @foreach($listMapelForSidebar as $mapel)
                <li>
                    {{-- REVISI: Logika 'active' pada link submenu disempurnakan --}}
                    {{-- Ini akan memeriksa apakah parameter 'mapel' di URL cocok dengan ID mapel saat ini --}}
                    <a href="{{ route('guru.penilaian.index', $mapel->id) }}"
                       class="{{ optional(request()->route('mapel'))->id == $mapel->id ? 'active' : '' }}">
                        
                        @if($mapel->nama_mapel == 'Bahasa Inggris')
                            <i class="fas fa-language"></i>
                        @elseif($mapel->nama_mapel == 'Calistung')
                            <i class="fas fa-calculator"></i>
                        @elseif($mapel->nama_mapel == 'Art / Kesenian')
                            <i class="fas fa-palette"></i>
                        @elseif($mapel->nama_mapel == 'Mandarin')
                            <i class="fas fa-globe-asia"></i>
                        @elseif($mapel->nama_mapel == 'Matematika')
                            <i class="fas fa-square-root-alt"></i>
                        @elseif($mapel->nama_mapel == 'Gucheng')
    ...
    <li class="nav-item {{ Route::is('guru.data-siswa.*') ? 'active' : '' }}">
        <a href="{{ route('guru.data-siswa.index') }}" class="nav-link"><i class="fas fa-users"></i><span>Data Nama Siswa</span></a>
    </li>
    <li class="nav-item {{ Route::is('guru.laporan.*') ? 'active' : '' }}">
       <a href="{{ route('guru.laporan.index') }}" class="nav-link"><i class="fas fa-file-signature"></i><span>Laporan Penilaian Siswa</span></a>
    </li>
</ul>
</aside>
        <div class="main-content full-width" id="main-content">
            <header class="header">
                <div class="header-left">
                    ...
                    {{-- REVISI: Logo di header sekarang disembunyikan oleh JS --}}
                    <a href="{{ route('guru.dashboard') }}" class="header-logo" id="header-logo" style="text-decoration: none;">
                        <img src="{{ asset('images/logohappyzone.png') }}" alt="Logo">
                        <span class="header-title">Happy Zone</span>
                    </a>
                </div>
                <nav class="header-nav">
                    <a href="{{ route('guru.notifications.index') }}"><i class="fas fa-bell"></i></a>
    ...
    {{-- REVISI: Pembaruan Logika JavaScript --}}
