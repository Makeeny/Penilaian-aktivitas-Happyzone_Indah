...
<head>
    ...
    <style>
       ...
       .logo-img {
        ...
        .hero-section {
            ...
            background-image: url("<?php echo e(asset('images/elementary.png')); ?>");
    ...
    .landing-page-body {
        ...
        background-image: url("<?php echo e(asset('images/elementary.png')); ?>"); /* Ganti dengan nama file gambar Anda */
    ...
    <header class="main-header">
        <div class="container header-content">
            <div class="logo-container">
                <img src="<?php echo e(asset('images/logohappyzone.png')); ?>" alt="Happy Zone Logo" class="logo-img" />
                <span class="logo-text">HAPPY ZONE</span>
            </div>
            <nav class="main-nav">
                <a href="#tentang">Tentang Kami</a>
                <a href="<?php echo e(route('login')); ?>">Log in</a>
                <a href="<?php echo e(route('register')); ?>" class="nav-button">Register</a>
            </nav>
        </div>
    </header>
    ...
    <section id="tentang" class="info-section container">
        <div class="content-card grid-2-col fade-in-element">
            <div class="image-placeholder">
                <img src="<?php echo e(asset('images/suasana-belajar.jpg')); ?>" alt="Suasana Belajar" class="section-image" />
            </div>
    ...
    <section id="fitur" class="info-section container">
        ...
        <div class="features-grid">
            <div class="content-card fade-in-element">
                <div class="image-placeholder">
                    <img src="<?php echo e(asset('images/pendidikan-dini.jpg')); ?>" alt="Pendidikan Dini" class="section-image" />
                </div>
                        ...
                        <div id="feedback-container">
                            <?php $__currentLoopData = $feedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="testimonial-card" style="display: none;">
                                    <p>"<?php echo e($item->pesan); ?>"</p>
                                    <span>- <?php echo e($item->nama_orang_tua); ?>, Orang Tua <?php echo e($item->nama_siswa); ?></span>
                                </div>
...
<?php /**PATH C:\laragon\www\happy-zone-final\resources\views/landing.blade.php ENDPATH**/ ?>